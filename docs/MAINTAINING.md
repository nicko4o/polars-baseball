...
| `docs/index.md` / `docs/zh-tw/index.md` | Documentation table of contents. | A document is added, removed, or moved. |
| `docs/api_index.md` / `docs/zh-tw/api_index.md` | Task-to-API chooser. | A public API adds a new user-visible use case. |
...
- Keep English and Traditional Chinese documentation structurally aligned. If a translation cannot be updated in the same change, say so in the pull request.
...
| `docs/index.md` / `docs/zh-tw/index.md` | 文件目錄。 | 文件新增、刪除或搬移時。 |
| `docs/api_index.md` / `docs/zh-tw/api_index.md` | 依任務選 API 的索引。 | Public API 新增使用者可見的使用情境時。 |
...
- 英文與繁中文件結構必須對齊。若同一個變更無法同步翻譯，必須在 PR 說明中明確註記。
