...
FILM_ROOM_SEARCH_URL = f"{MLB_ROOT}/video/search"
FORGE_CDN_BASE_URL = "https://mlb-cuts-diamond.mlb.com/FORGE"
...
DEFAULT_GAMEFEED_CONCURRENCY_LIMIT = 5


STATCAST_FIRST_YEAR: int = 2008
STATCAST_PARK_FACTORS_START_YEAR: int = 2015
